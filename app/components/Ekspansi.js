...
class Ekspansi extends Component{
	constructor(props) {
	  super(props);	
	  this.state = {
	  		result:[],
	...
	hanldeAction(){
		  this.setState({ loading: true});
			const { num1,num2,num3,num4,num5,num6,num7,num8 } = this.state;
			fetch(`http://45.63.62.230:8012/sys/public/api/notrcon/${num1}/${num2}/${num3}/${num4}/${num5}/${num6}/${num7}/${num8}`)
